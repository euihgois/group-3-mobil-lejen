...
const db_skin =/*!(sessionStorage.getItem('db_skin')===undefined) ? (sessionStorage.getItem('db_skin')):*/ {//data untuk skin 
    mobil1: {
...
function updateDisplayWallet() {
    document.getElementById("user-wallet").innerHTML = userWallet;
}
//test case
